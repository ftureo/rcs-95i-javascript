console.log("Render List Script Loaded");

// Obtener el nodo principal en donde vamos a intentar hacer inyección de contenido (inserción al DOM)
...
// TAREAS
// Buscar cómo funciona el método querySelectorAll
// Buscar cómo funciona el método getElementByClassName
// ¿Se puede buscar por etiqueta HTML (tag)? ¿Cómo?

// Classes de Bootstrap que podemos aplicar al nodo principal
// Display Flex con Bootstrap: d-flex
// Flex wrap con Bootstrap: flex-wrap
// Justify content con Bootstrap: justify-content-evenly

const classesToApplyInMainSection = ["d-flex", "flex-wrap", "justify-content-evenly", "mb-4"];

// Spread operator: ...
// Operador que me permite desglosar un array(solo un array?) en sus elementos individuales
mainSection.classList.add(...classesToApplyInMainSection)
...
const recipes = [
    ...
    },
    {
        ...
        "imageURL": "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/recipe-image-legacy-id-559480_11-ec53335.jpg?quality=90&webp=true&resize=375,341"
    },
    {
        ...
        "imageURL": "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/recipe-image-legacy-id-444572_12-4487e3a.jpg?quality=90&webp=true&resize=375,341"
    },
    {
        "Name": "Christmas buns",
        ...
        "imageURL": "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/recipe-image-legacy-id-836565_11-719faac.jpg?quality=90&webp=true&resize=375,341"
    },
    {
        "Name": "Christmas cupcakes",
        "url": "https://www.bbcgoodfood.com/recipes/981634/christmas-cupcakes",
        "Description": "Made these for the second time today, and I have to say they turned out great! I've got large muffin tins and the mixture made 15 muffins, will definetely make these again at christmas time and decorate festively.",
        ...
        "imageURL": "https://images.immediate.co.uk/production/volatile/sites/30/2021/08/christmas-cupcakes-d34f231.jpg?quality=90&webp=true&resize=375,341"
    },
    {
        "Name": "Christmas slaw",
        ...
        "imageURL": "https://images.immediate.co.uk/production/volatile/sites/30/2010/11/Winter-slaw-e23d82a.jpg?quality=90&webp=true&resize=375,341"
    },
    {
        "Name": "Christmas mess",
        ...
        "imageURL": "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/recipe-image-legacy-id-1163480_10-f4113c0.jpg?quality=90&webp=true&resize=375,341"
    },
    {
        ...
        "imageURL": "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/chrismas-brownies-cfc47c9.jpg?quality=90&webp=true&resize=375,341"
    },
    {
        ...
        "imageURL": "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/recipe-image-legacy-id-463806_11-85e1497.jpg?quality=90&webp=true&resize=375,341"
    },
    {
        ...
        "imageURL": "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/pizza_2-5a1fe2f.jpg?quality=90&webp=true&resize=375,341"
    }
]
...
// Crear una función que se encargue de recibir una receta como parámetro y me cree una card con la información de la receta

// console.log(recipe) // Name, Description, Author, Ingredients, Method, imageURL, url
// Para acceder al nombre debería hacer recipe.Name
// Para acceder a la descripción debería hacer recipe.Description
// Para acceder al autor debería hacer recipe.Author
// ...

// Puedo empezar a utilizar *destructuring de propiedades*

const createRecipeCard = (recipe) => {
    console.log(recipe)

    // Puedo empezar a utilizar *destructuring de propiedades* me permite extraer propiedades de un objeto y asignarlas a variables, pudiendo quedarme solo con las que me interesan (Y además se escribe más prolijo)
    const { Name, Description, Author, Ingredients, Method, imageURL, url } = recipe

    // Crear elementos HTML

    // Creo el contenedor de la card
    ...
    // Creo el contenedor del cuerpo de la card
    const infoRecipeContainer = document.createElement("div");
    infoRecipeContainer.style.display = "flex"
    infoRecipeContainer.style.flexDirection = "column"
    infoRecipeContainer.style.justifyContent = "space-between"
    // TAREA: Reemplazar por un array de styles usando bootstrap
    infoRecipeContainer.classList.add("card-body")
    ...
    anchor.textContent = "Go to recipe"
    anchor.target = "_blank"

    //     // Agregar clases a los elementos
    //     cardContainer.classList.add("card");
    //     // ... Agregar clases a los demás elementos


    // Agregar los elementos como hijos del nodo que tenga como padre - appendChild

    // Appendeo la info a infoRecipeContainer - div
    infoRecipeContainer.appendChild(title)
    infoRecipeContainer.appendChild(author)
    infoRecipeContainer.appendChild(description)

    cardContainer.appendChild(image)
    cardContainer.appendChild(infoRecipeContainer)
    cardContainer.appendChild(anchor)

    return cardContainer
}

// Crear una función que ejecute un forEach() sobre el array de recetas y que por cada receta ejecute la función que creamos en el paso anterior. Este método será el que se encargue de renderizar dinámicamente las recetas en la página

const renderListRecipes = () => {
    recipes.forEach((recipe) => {
        console.log("Recipe dentro del forEach")

        const card = createRecipeCard(recipe)
        console.log("A ver la card", card)
